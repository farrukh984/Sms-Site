        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSeenPrivacy = table.Column<string>(type: "text", nullable: false),
                    ProfilePicPrivacy = table.Column<string>(type: "text", nullable: false),
                    AboutPrivacy = table.Column<string>(type: "text", nullable: false),
                    StatusPrivacy = table.Column<string>(type: "text", nullable: false),
                    GroupsPrivacy = table.Column<string>(type: "text", nullable: false),
                    ReadReceipts = table.Column<bool>(type: "boolean", nullable: false),
                    BlockUnknownMessages = table.Column<bool>(type: "boolean", nullable: false),
                    DisableLinkPreviews = table.Column<bool>(type: "boolean", nullable: false),
                    DisappearingTimer = table.Column<string>(type: "text", nullable: false),
                    Theme = table.Column<string>(type: "text", nullable: false),
                    Wallpaper = table.Column<string>(type: "text", nullable: false),
                    MediaUploadQuality = table.Column<string>(type: "text", nullable: false),
                    MediaAutoDownload = table.Column<string>(type: "text", nullable: false),
                    SpellCheck = table.Column<bool>(type: "boolean", nullable: false),
                    ReplaceTextWithEmoji = table.Column<bool>(type: "boolean", nullable: false),
                    EnterIsSend = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommunityGroups_Chats_ChatId",
                        column: x => x.ChatId,
                        principalTable: "Chats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommunityGroups_Communities_CommunityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatusViewers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StatusViewers_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StatusViewers_Users_ViewerId",
                        column: x => x.ViewerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityGroups_ChatId",
                table: "CommunityGroups",
                column: "ChatId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunityGroups_CommunityId",
                table: "CommunityGroups",
                column: "CommunityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusViewers_StatusId",
                table: "StatusViewers",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_StatusViewers_ViewerId",
                table: "StatusViewers",
                column: "ViewerId");
